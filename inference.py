...
from generation import text_to_token, token_ids_to_text, generate
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help='[Generation] Top-k sampling parameter'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help='[Classification] Number of classes'
    )
    parser.add_argument(
        '--max_length',
        type=int,
    ...
    if 'config' in checkpoint and checkpoint['config'] is not None:
        ...
        print(f"Using {args.model_size} config with context_length={args.context_length}, qkv_bias={args.qkv_bias}")
