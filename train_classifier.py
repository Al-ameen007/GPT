...
from engine import train_classifier_simple, calc_accuracy_loader
from checkpoint import save_model
from weights import load_weights_into_classifier
...
def main():
    ...
    train_df, val_df, test_df = random_split(balanced_df, args.train_ratio, args.val_ratio)
